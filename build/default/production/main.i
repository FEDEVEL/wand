...
void lumos(){
    ...
    DELAY_milliseconds(100);
    int8_t previous = I2C1_Read1ByteRegister(0x0E, 0x09);
    while(on){


        if(mathAbs(I2C1_Read1ByteRegister(0x0E, 0x09)-previous) > 20){
            on = 0;
        }
# 165 "main.c"
        EPWM1_LoadDutyValue(11);
...
# 562 "main.c"
        previous_data_x = I2C1_Read1ByteRegister(0x0E, 0x07);
        previous_data_y = I2C1_Read1ByteRegister(0x0E, 0x09);
        previous_data_z = I2C1_Read1ByteRegister(0x0E, 0x0B);
